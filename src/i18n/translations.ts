...
export const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    aiInitialMessage: "Hello! I'm the Climate Loop AI assistant. How can I help you today?",
    ...
    profileRatingHint: "Avg. rating of your reports",
...
Users may lodge a complaint with their competent data protection authority within the EU.`,
    ...
    iotInfoDesc3: "The Climate Loop network is growing — the more sensors deployed in your area, the more precise and localized the climate information becomes. Each sensor covers an approximate radius of 5km.",
  ...
  es: {
    ...
    aiInitialMessage: "¡Hola! Soy el asistente de IA de Climate Loop. ¿En qué puedo ayudarte hoy?",
    ...
    profileRatingHint: "Media de valoraciones de tus reportes",
...
Los usuarios pueden presentar una reclamación ante la autoridad de protección de datos competente dentro de la UE.`,
    ...
    iotInfoDesc3: "La red Climate Loop está creciendo — cuantos más sensores se desplieguen en tu zona, más precisa y localizada será la información climática. Cada sensor cubre un radio aproximado de 5km.",
  ...
  pt: {
    ...
    aiInitialMessage: "Olá! Sou o assistente de IA do Climate Loop. Como posso te ajudar hoje?",
    ...
    profileRatingHint: "Média das avaliações dos seus relatos",
...
Os usuários podem apresentar reclamação à autoridade de proteção de dados competente dentro da UE.`,
    ...
    menuAbout: "Sobre o Climate Loop",
    ...
    iotInfoDesc3: "A rede Climate Loop está crescendo — quanto mais sensores na sua região, mais precisa e localizada será a informação climática. Cada sensor cobre um raio aproximado de 5km.",
  ...
  fr: {
    ...
    aiInitialMessage: "Bonjour ! Je suis l'assistant IA de Climate Loop. Comment puis-je vous aider aujourd'hui ?",
    ...
    profileRatingHint: "Moyenne des évaluations de vos signalements",
...
Les utilisateurs peuvent déposer une plainte auprès de l'autorité de protection des données compétente au sein de l'UE.`,
    ...
    menuAbout: "À propos de Climate Loop",
    ...
    iotInfoDesc3: "Le réseau Climate Loop grandit — plus il y a de capteurs dans votre zone, plus les informations climatiques seront précises et localisées. Chaque capteur couvre un rayon d'environ 5km.",
