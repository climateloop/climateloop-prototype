...
export const translations: Record<Locale, TranslationKeys> = {
  ...
  es: {
    ...
    legalTermsContent: "(Contenido equivalente adaptado a normativa europea, GDPR y AI Act)\nClimate Loop aplica principios de minimización de datos, transparencia en IA, evaluación basada en riesgo y supervisión humana proporcional.",
    legalPrivacyContent: "El tratamiento cumple con el Reglamento General de Protección de Datos (GDPR). Base jurídica: ejecución de contrato, interés legítimo y consentimiento. Se garantizan derechos de acceso, rectificación, supresión, limitación y portabilidad.",
  ...
  pt: {
    ...
    legalTermsContent: "O Climate Loop opera sob princípios de minimização de dados, transparência algorítmica e conformidade com o GDPR e o AI Act europeu. Sistemas de IA utilizados não são classificados como de alto risco.",
    legalPrivacyContent: "Tratamento baseado em execução de contrato, legítimo interesse e consentimento. Direitos garantidos: acesso, correção, exclusão, portabilidade e limitação de tratamento.",
  ...
  fr: {
    ...
    legalTermsContent: "Climate Loop applique les principes de minimisation des données, transparence algorithmique et conformité au RGPD et au AI Act.",
    legalPrivacyContent: "Traitement conforme au RGPD. Bases légales : exécution du contrat, intérêt légitime et consentement. Droits garantis : accès, rectification, effacement, portabilité et limitation.",
