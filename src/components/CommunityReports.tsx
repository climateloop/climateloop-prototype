...
const reports: CommunityReport[] = [
  ...
  { id: "7", user: "Isabel F.", typeKey: "typeFlooding", description: "Río Miño crecido con desbordamento parcial na zona do Balneario", time: "55 min", hasPhoto: true, lat: 43.0060, lng: -7.5620, positiveRatings: 9, totalRatings: 11, translations: { es: { title: "Río Miño crecido con desbordamento parcial na zona do Balneario" }, en: { title: "River Miño risen with partial overflow near the Balneario area" }, pt: { title: "Rio Miño crescido com transbordamento parcial na zona do Balneário" }, fr: { title: "Río Miño en crue avec débordement partiel dans la zone du Balneario" } } },
  { id: "8", user: "Diego T.", typeKey: "typeRain", description: "Chuvia intermitente con pozas na Rúa San Pedro", time: "25 min", hasPhoto: true, lat: 43.0105, lng: -7.5555, positiveRatings: 3, totalRatings: 5, translations: { es: { title: "Chuvia intermitente con pozas na Rúa San Pedro" }, en: { title: "Intermittent rain with puddles on Rúa San Pedro" }, pt: { title: "Chuva intermitente com poças na Rúa San Pedro" }, fr: { title: "Pluie intermittente avec flaques sur la Rúa San Pedro" } } },
];
