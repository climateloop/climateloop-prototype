...
const reports: CommunityReport[] = [
  { id: "1", user: "María S.", typeKey: "typeFlooding", description: "Calle de la Reina completamente inundada tras fuerte lluvia", time: "15 min", hasPhoto: true, lat: 43.0101, lng: -7.5570, userId: MOCK_USER_ID, positiveRatings: 12, totalRatings: 13, translations: { es: { title: "Calle de la Reina completamente inundada tras fuerte lluvia" }, en: { title: "Calle de la Reina completely flooded after heavy rain" }, pt: { title: "Calle de la Reina completamente inundada após chuva forte" }, fr: { title: "Calle de la Reina complètement inondée après de fortes pluies" } } },
  { id: "3", user: "Ana L.", typeKey: "typeStrongWind", description: "Árbol caído en la Calle Nueva bloqueando el tráfico", time: "1h", hasPhoto: true, lat: 43.0090, lng: -7.5545, userId: MOCK_USER_ID, positiveRatings: 11, totalRatings: 12, translations: { es: { title: "Árbol caído en la Calle Nueva bloqueando el tráfico" }, en: { title: "Fallen tree on Calle Nueva blocking traffic" }, pt: { title: "Árvore caída na Calle Nueva bloqueando o trânsito" }, fr: { title: "Arbre tombé sur la Calle Nueva bloquant la circulation" } } },
